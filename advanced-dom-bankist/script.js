...
// Attach event handler for each tab
tabsContainer.addEventListener("click", function (e) {
  const clicked = e.target.closest(".operations__tab"); // to prevent getting the span when clicking on numbers (gives span in the console)
  // console.log(clicked);
  // Guard clause
  if (!clicked) return;
